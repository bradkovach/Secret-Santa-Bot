...
const indexedByTwo = new Map( countryData.map( country => [country["twoAlpha"], country]));
const indexedByThree = new Map( countryData.map( country => [country["threeAlpha"], country]));
